...
/// @nodoc
mixin _$Player {
  bool get isNPC => throw _privateConstructorUsedError;
...
abstract class $PlayerCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isNPC, String name});
}
...
class _$PlayerCopyWithImpl<$Res, $Val extends Player>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      isNPC: null == isNPC
          ? _value.isNPC
          : isNPC // ignore: cast_nullable_to_non_nullable
              as bool,
      name: null == name
          ? _value.name
...
class _$_Player implements _Player {
  _$_Player({required this.isNPC, required this.name});
  ...
  @override
  String toString() {
    return 'Player(isNPC: $isNPC, name: $name)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_Player &&
            (identical(other.isNPC, isNPC) || other.isNPC == isNPC) &&
            (identical(other.name, name) || other.name == name));
  }

  @override
  int get hashCode => Object.hash(runtimeType, isNPC, name);
...
abstract class _Player implements Player {
  factory _Player({required final bool isNPC, required final String name}) =
      _$_Player;
