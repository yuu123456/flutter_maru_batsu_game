...
abstract class $WeatherModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? dt, String? name, Main? main, List<Weather>? weather});
...
class _$_WeatherModel implements _WeatherModel {
  _$_WeatherModel({this.dt, this.name, this.main, final List<Weather>? weather})
      : _weather = weather;
  ...
  @override
  String toString() {
    return 'WeatherModel(dt: $dt, name: $name, main: $main, weather: $weather)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, dt, name, main,
...
abstract class _WeatherModel implements WeatherModel {
  factory _WeatherModel(
      ...
      final String? name,
      final Main? main,
      final List<Weather>? weather}) = _$_WeatherModel;
...
class _$_Main implements _Main {
  _$_Main({this.temp, this.humidity});
...
abstract class _Main implements Main {
  factory _Main({final double? temp, final int? humidity}) = _$_Main;
...
abstract class _Weather implements Weather {
  factory _Weather({final String? icon}) = _$_Weather;
